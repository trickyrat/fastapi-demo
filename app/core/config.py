...
class Settings(BaseSettings):
    ...
    SQLALCHEMY_DATABASE_URI: Optional[
        str
    ] = "mysql+pymysql://root:Trickyrat_05@localhost:3306/fastapidemo?charset=utf8"
    # SQLALCHEMY_DATABASE_URI: Optional[str] = "mssql+pymssql://sa:trickyrat@localhost/fastapidemo"
    # DATABASE: str = "mysql"
